...
module "mig_ue1" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/compute-mig?ref=v37.3.0"
  project_id = module.project.project_id
  location   = "us-east1"
...
module "glb" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/net-lb-app-ext?ref=v34.1.0"
