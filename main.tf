...
module "mig_ew1" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/compute-mig?ref=v18.0.0"
  project_id = module.project.project_id
...
module "glb" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/net-glb?ref=v18.0.0"
